...
(* === oldest === *)
val test_oldest1 = oldest([]) = NONE
val test_oldest2 = oldest([(2012,2,28),(2011,3,31),(2011,4,28)]) = SOME (2011, 3, 31)
val test_oldest3 = oldest([(2077, 01, 02)]) = SOME (2077, 01, 02)
val test_oldest4 = oldest([(5,12,15),(5,12,10),(5,12,1)]) = SOME (5, 12, 1)
